            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <h1 class="mt-0 header-title text-primary my-4 text-center">Listagem Fornecedores</h1>    
                            <a href="{{ url('admin/fornecedores/adicionar')}}" class="btn btn-primary pull-right">Adicionar novo <i class="dripicons-plus" aria-hidden="true"></i></a>
                                    ...
                                    <tr id="fornecedor-{{ $item->id}}">
                                        ...
                                        <td>
                                            <button class="btn btn-info btn-sm">
                                                <a style="color: #fff !important;" href="{{route('admin.fornecedores.atualizar', $item->id)}}">Editar <i class="dripicons-paperclip" aria-hidden="true"></i> </a>
                                            </button>   
                                            ...
                                            <button class="btn btn-danger btn-sm excluir" fornecedor="{{ $item->id}}">
